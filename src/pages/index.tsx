    ...
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20 relative">
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-12 xl:gap-20 items-center">
          ...
          <div className="hidden xl:block opacity-0 animate-fade-in animate-delay-500">
            <div className="relative">
              <div className="w-full max-w-[600px] bg-white rounded-3xl shadow-2xl border border-brand-100 overflow-hidden animate-float">
                ...
                <div className="p-6 bg-brand-50">
                  <div className="grid grid-cols-4 gap-3 mb-5">
                    {[1, 2, 3, 4].map((i) => (
                      <div key={i} className="bg-white rounded-xl p-3 shadow-sm">
                        <div className="w-7 h-7 rounded-lg bg-accent/10 mb-2" />
                        <div className="h-5 bg-brand-100 rounded w-12 mb-1" />
                  ...
                  <div className="bg-white rounded-xl p-4 shadow-sm">
                    <div className="flex justify-between items-center mb-4">
                      <div className="h-4 bg-brand-100 rounded w-28" />
                      <div className="h-7 bg-accent/10 rounded-full w-20" />
                    </div>
                    {[1, 2, 3].map((i) => (
                      <div key={i} className="flex items-center gap-3 py-3 border-b border-brand-50 last:border-0">
                        <div className="w-9 h-9 rounded-full bg-brand-100" />
                        <div className="flex-1">
                          <div className="h-3 bg-brand-100 rounded w-24 mb-1" />
                          <div className="h-2 bg-brand-50 rounded w-36" />
                        </div>
                        <div className="h-5 bg-green-100 rounded-full w-14" />
                      </div>
                    ))}
                  </div>
                </div>
              ...
              {/* Decorative elements */}
              <div className="absolute -top-4 -right-4 w-16 h-16 bg-brand-200/50 rounded-full" />
              <div className="absolute -bottom-4 -left-4 w-12 h-12 bg-accent/20 rounded-xl rotate-12" />
            </div>
          </div>
        </div>
      </div>
